...
<title>${esc(obj.titel)} – Exposé V12</title>
<style>
:root{
  --petrol:#00424a;
  --petrol2:#073f43;
...
.description-copy{position:absolute;top:282px;left:74px;width:615px;max-height:396px;overflow:hidden;color:#202020;font-size:16.5px;line-height:1.38;font-weight:400;letter-spacing:-.006em}
.description-copy.medium{font-size:15.2px;line-height:1.30;max-height:400px}
.description-copy.long{font-size:14px;line-height:1.24;max-height:404px}
.description-copy.xlong{font-size:13px;line-height:1.18;max-height:408px}
.highlights-title{position:absolute;top:704px;left:74px;width:615px;color:#202020;font-size:16.5px;line-height:1.2;font-weight:800}
.highlights-list{position:absolute;top:730px;left:93px;width:585px;margin:0;padding:0;color:#202020;font-size:13.5px;line-height:1.30;font-weight:400}
...
.contact-name{position:absolute;left:445px;bottom:205px;color:var(--gold);font-family:Georgia,'Times New Roman',serif;font-weight:700;font-size:25px;line-height:.98;letter-spacing:-.008em}
...
<body data-expose-template="v12-canva-typography-refined">
