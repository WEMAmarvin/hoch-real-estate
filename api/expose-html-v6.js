...
<title>${esc(obj.titel)} – Exposé V6</title>
<style>
...
/* SEITE 1 */
.logo-cover{position:absolute;top:150px;left:50%;transform:translateX(-50%);width:330px;height:auto}
...
.cover-object{position:absolute;top:620px;left:100px;width:calc(100% - 200px);text-align:center;color:#fff;font-size:16px;line-height:1.35;font-weight:800;text-transform:uppercase;letter-spacing:.02em}
.cover-location{position:absolute;top:700px;left:100px;width:calc(100% - 200px);text-align:center;color:rgba(255,255,255,.9);font-size:9px;line-height:1.35;font-weight:900;text-transform:uppercase;letter-spacing:.08em}

/* SEITE 2 — KEINE BILDERGALERIE. Nur Titel, Beschreibung, Highlights, Preis. */
.page-label{position:absolute;top:62px;left:74px;color:var(--gold);font-size:8px;letter-spacing:.24em;font-weight:900;text-transform:uppercase}
.description-title{position:absolute;top:104px;left:74px;width:440px;color:var(--petrol);font-family:Georgia,'Times New Roman',serif;font-size:44px;line-height:.95;font-weight:700;letter-spacing:-.025em;text-transform:uppercase}
.description-location{position:absolute;top:245px;left:74px;width:440px;color:var(--gray);font-size:11px;line-height:1.35;font-weight:700}
.description-copy{position:absolute;top:292px;left:74px;width:455px;max-height:325px;overflow:hidden;color:var(--dark);font-size:12px;line-height:1.55;font-weight:400}
.highlights-title{position:absolute;top:655px;left:74px;width:455px;color:var(--petrol);font-size:13px;line-height:1.2;font-weight:900}
.highlights-list{position:absolute;top:684px;left:92px;width:430px;margin:0;padding:0;color:var(--dark);font-size:11px;line-height:1.42;font-weight:400}
.highlights-list li{margin-bottom:5px}
.price-line{position:absolute;left:74px;bottom:65px;display:flex;align-items:baseline;gap:22px;color:var(--gold);font-weight:900}
.price-line .price{font-size:22px;line-height:1}
.price-line .type{color:var(--gray);font-size:8px;letter-spacing:.15em;text-transform:uppercase;font-weight:900}
.small-footer{position:absolute;right:74px;bottom:65px;width:230px;text-align:right;color:rgba(107,114,128,.55);font-size:7px;letter-spacing:.02em}

/* Seite 2 alte Galerie sicher ausblenden */
.side-gallery{display:none!important}

/* SEITE 3 — BILDERGRID OBEN, FAKTEN DARUNTER */
.object-title{position:absolute;top:62px;left:58px;color:var(--petrol);font-family:Georgia,'Times New Roman',serif;font-size:46px;line-height:.95;font-weight:700;letter-spacing:-.025em;text-transform:uppercase}
.gold-rule{position:absolute;top:132px;left:58px;width:calc(100% - 116px);height:1.3px;background:var(--gold)}

.object-images{position:absolute;left:58px;right:58px;top:165px;height:355px;display:grid;gap:10px}
...
.object-images.count-3{grid-template:1fr 1fr/1.35fr 1fr}
...
.object-images.count-6{grid-template:1.35fr 1fr/repeat(3,1fr)}
...
.facts-grid{position:absolute;top:565px;left:58px;width:calc(100% - 116px);display:grid;grid-template-columns:repeat(3,1fr);gap:11px}
.fact-card{height:63px;border:1px solid rgba(200,164,107,.30);background:rgba(247,244,239,.88);border-radius:4px;padding:11px 13px 9px}
.fact-label{color:var(--gold);font-size:6.5px;line-height:1;letter-spacing:.20em;font-weight:900;text-transform:uppercase;margin-bottom:9px}
.fact-value{color:var(--petrol);font-size:11.5px;line-height:1.15;font-weight:900;max-height:28px;overflow:hidden}

/* SEITE 4 — Kontakt ohne Überschneidung, dichter am Template */
.contact-heading{position:absolute;top:95px;left:95px;right:95px;text-align:center;color:var(--petrol);font-family:Georgia,'Times New Roman',serif;font-size:50px;line-height:1.04;font-weight:700;letter-spacing:-.014em;text-transform:uppercase}
.contact-sub{position:absolute;top:405px;left:0;width:100%;text-align:center;color:var(--gray);font-size:17px;font-weight:900;letter-spacing:.02em;text-transform:uppercase}
.contact-logo{position:absolute;left:76px;bottom:80px;width:215px;height:auto}
.contact-name{position:absolute;left:445px;bottom:198px;color:var(--gold);font-family:Georgia,'Times New Roman',serif;font-weight:700;font-size:22px;line-height:1}
.contact-role{position:absolute;left:445px;bottom:176px;color:#fff;font-family:Georgia,'Times New Roman',serif;font-size:12px}
.contact-lines{position:absolute;left:445px;bottom:76px;width:245px;display:grid;gap:10px}
.contact-line{display:grid;grid-template-columns:22px 1fr;gap:12px;align-items:center;color:#fff;font-size:9.5px;line-height:1.2;font-weight:800}
...
<body data-expose-template="v6-layout-corrected">
...
<section class="page bg-plain"><div class="object-title">OBJEKTDATEN</div><div class="gold-rule"></div><div class="object-images count-${secondCount}">${secondGalleryHtml}</div><div class="facts-grid">${factHtml}</div></section>
<section class="page bg-contact"><div class="contact-heading">SIE HABEN<br>INTERESSE<br>AN DIESEM<br>OBJEKT?</div><div class="contact-sub">WIR BERATEN SIE GERNE!</div><img class="contact-logo" src="/assets/hoch-logo-vertical.png"><div class="contact-name">Christian Hoch</div><div class="contact-role">Geschäftsführer</div><div class="contact-lines"><div class="contact-line"><span class="dot"></span><span>+49 (0) 171 5744 947</span></div><div class="contact-line"><span class="dot"></span><span>christian@hoch-real-estate.de</span></div><div class="contact-line"><span class="dot"></span><span>www.hoch-real-estate.de</span></div><div class="contact-line"><span class="dot"></span><span>Emsstraße 18, 26135 Oldenburg</span></div></div></section>
</body></html>`;
