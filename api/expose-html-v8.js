...
<title>${esc(obj.titel)} – Exposé V8</title>
<style>
:root{
  --petrol:#00424a;
  --petrol2:#073f43;
...
<body data-expose-template="v8-professional-canva-clean">
...
<section class="page bg-plain">
  ...
  ${highlightsHtml}
  <div class="price-claim">Erlebe urbanes Wohnen neu!</div>
...
<section class="page bg-contact">
  ...
  <div class="contact-name">Christian Hoch</div>
