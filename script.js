      ...
      <div class="immo-premium-modal">
        ...
        <div class="immo-premium-modal-body">
          ...
          <div class="immo-premium-cta-wrap immo-premium-cta-actions">
            ...
            <a href="/api/expose-html-v12?id=${encodeURIComponent(obj.notionId)}" target="_blank" rel="noopener noreferrer" class="immo-modal-cta immo-modal-cta-secondary">Exposé herunterladen</a>
          </div>
        </div>
      </div>`;
